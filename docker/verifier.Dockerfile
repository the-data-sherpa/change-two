...
RUN pnpm --filter "@change-two/runner" exec playwright install --with-deps chromium
COPY packages/runner/src/verification-app.mjs packages/runner/src/verification-app.mjs
COPY packages/runner/src/verification-checker.mjs packages/runner/src/verification-checker.mjs
